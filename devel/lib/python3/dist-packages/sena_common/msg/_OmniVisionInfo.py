...
"""autogenerated by genpy from sena_common/OmniVisionInfo.msg. Do not edit."""
import codecs
import sys
...
class OmniVisionInfo(genpy.Message):
  _md5sum = "4eaad8c4086a32cd112b24e241236839"
  _type = "sena_common/OmniVisionInfo"
...
"""
  ...
  _slot_types = ['std_msgs/Header','sena_common/BallInfo']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.ballinfo is None:
        self.ballinfo = sena_common.msg.BallInfo()
    else:
      self.header = std_msgs.msg.Header()
      self.ballinfo = sena_common.msg.BallInfo()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_i2f2B().pack(_x.ballinfo.ballinfostate, _x.ballinfo.real_pos.angle, _x.ballinfo.real_pos.radius, _x.ballinfo.pos_known, _x.ballinfo.velocity_known))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ballinfo.ballinfostate, _x.ballinfo.real_pos.angle, _x.ballinfo.real_pos.radius, _x.ballinfo.pos_known, _x.ballinfo.velocity_known,) = _get_struct_i2f2B().unpack(str[start:end])
