...
(cl:defmethod cl:initialize-instance :after ((m <PPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-msg:<PPoint> is deprecated: use sena_msgs-msg:PPoint instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <PPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:angle-val is deprecated.  Use sena_msgs-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <PPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:radius-val is deprecated.  Use sena_msgs-msg:radius instead.")
  (radius m))
