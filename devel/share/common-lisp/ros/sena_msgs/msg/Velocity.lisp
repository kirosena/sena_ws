...
(cl:defmethod cl:initialize-instance :after ((m <Velocity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Velocity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-msg:<Velocity> is deprecated: use sena_msgs-msg:Velocity instead.")))

(cl:ensure-generic-function 'v_left-val :lambda-list '(m))
(cl:defmethod v_left-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:v_left-val is deprecated.  Use sena_msgs-msg:v_left instead.")
  (v_left m))

(cl:ensure-generic-function 'v_right-val :lambda-list '(m))
(cl:defmethod v_right-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:v_right-val is deprecated.  Use sena_msgs-msg:v_right instead.")
  (v_right m))

(cl:ensure-generic-function 'v_back-val :lambda-list '(m))
(cl:defmethod v_back-val ((m <Velocity>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:v_back-val is deprecated.  Use sena_msgs-msg:v_back instead.")
  (v_back m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Velocity>)))
  ...
  "f242f54cda2fad8ff062e66077f57b70")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Velocity)))
  "Returns md5sum for a message object of type 'Velocity"
  "f242f54cda2fad8ff062e66077f57b70")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Velocity>)))
  ...
  (cl:format cl:nil "float64 v_left~%float64 v_right~%float64 v_back~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Velocity)))
  "Returns full string definition for message of type 'Velocity"
  (cl:format cl:nil "float64 v_left~%float64 v_right~%float64 v_back~%~%~%"))
