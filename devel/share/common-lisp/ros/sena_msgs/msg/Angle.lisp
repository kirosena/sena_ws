...
(cl:defmethod cl:initialize-instance :after ((m <Angle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Angle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-msg:<Angle> is deprecated: use sena_msgs-msg:Angle instead.")))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Angle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-msg:theta-val is deprecated.  Use sena_msgs-msg:theta instead.")
  (theta m))
