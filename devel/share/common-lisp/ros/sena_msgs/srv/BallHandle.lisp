...
(cl:defmethod cl:initialize-instance :after ((m <BallHandle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallHandle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-srv:<BallHandle-request> is deprecated: use sena_msgs-srv:BallHandle-request instead.")))

(cl:ensure-generic-function 'enable-val :lambda-list '(m))
(cl:defmethod enable-val ((m <BallHandle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-srv:enable-val is deprecated.  Use sena_msgs-srv:enable instead.")
  (enable m))
...
(cl:defmethod cl:initialize-instance :after ((m <BallHandle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallHandle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-srv:<BallHandle-response> is deprecated: use sena_msgs-srv:BallHandle-response instead.")))

(cl:ensure-generic-function 'BallIsHolding-val :lambda-list '(m))
(cl:defmethod BallIsHolding-val ((m <BallHandle-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-srv:BallIsHolding-val is deprecated.  Use sena_msgs-srv:BallIsHolding instead.")
  (BallIsHolding m))
