...
(cl:defmethod cl:initialize-instance :after ((m <Shoot-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Shoot-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-srv:<Shoot-request> is deprecated: use sena_msgs-srv:Shoot-request instead.")))

(cl:ensure-generic-function 'strength-val :lambda-list '(m))
(cl:defmethod strength-val ((m <Shoot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-srv:strength-val is deprecated.  Use sena_msgs-srv:strength instead.")
  (strength m))

(cl:ensure-generic-function 'ShootPos-val :lambda-list '(m))
(cl:defmethod ShootPos-val ((m <Shoot-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-srv:ShootPos-val is deprecated.  Use sena_msgs-srv:ShootPos instead.")
  (ShootPos m))
...
(cl:defmethod cl:initialize-instance :after ((m <Shoot-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Shoot-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_msgs-srv:<Shoot-response> is deprecated: use sena_msgs-srv:Shoot-response instead.")))

(cl:ensure-generic-function 'ShootIsDone-val :lambda-list '(m))
(cl:defmethod ShootIsDone-val ((m <Shoot-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_msgs-srv:ShootIsDone-val is deprecated.  Use sena_msgs-srv:ShootIsDone instead.")
  (ShootIsDone m))
