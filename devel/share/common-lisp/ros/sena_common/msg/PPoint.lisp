...
(cl:defmethod cl:initialize-instance :after ((m <PPoint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PPoint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_common-msg:<PPoint> is deprecated: use sena_common-msg:PPoint instead.")))

(cl:ensure-generic-function 'angle-val :lambda-list '(m))
(cl:defmethod angle-val ((m <PPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:angle-val is deprecated.  Use sena_common-msg:angle instead.")
  (angle m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <PPoint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:radius-val is deprecated.  Use sena_common-msg:radius instead.")
  (radius m))
