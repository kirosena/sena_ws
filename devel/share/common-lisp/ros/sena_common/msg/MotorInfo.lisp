...
(cl:defmethod cl:initialize-instance :after ((m <MotorInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_common-msg:<MotorInfo> is deprecated: use sena_common-msg:MotorInfo instead.")))
...
(cl:defmethod motordata-val ((m <MotorInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:motordata-val is deprecated.  Use sena_common-msg:motordata instead.")
  (motordata m))
