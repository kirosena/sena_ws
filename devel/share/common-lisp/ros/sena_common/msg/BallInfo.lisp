...
(cl:defclass <BallInfo> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (real_pos
    :reader real_pos
    :initarg :real_pos
    :type sena_common-msg:PPoint
    :initform (cl:make-instance 'sena_common-msg:PPoint))
   (pos_known
    :reader pos_known
    :initarg :pos_known
    :type cl:boolean
...
(cl:defmethod cl:initialize-instance :after ((m <BallInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BallInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sena_common-msg:<BallInfo> is deprecated: use sena_common-msg:BallInfo instead.")))
...
(cl:defmethod ballinfostate-val ((m <BallInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:ballinfostate-val is deprecated.  Use sena_common-msg:ballinfostate instead.")
  (ballinfostate m))

(cl:ensure-generic-function 'real_pos-val :lambda-list '(m))
(cl:defmethod real_pos-val ((m <BallInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:real_pos-val is deprecated.  Use sena_common-msg:real_pos instead.")
  (real_pos m))

(cl:ensure-generic-function 'pos_known-val :lambda-list '(m))
(cl:defmethod pos_known-val ((m <BallInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:pos_known-val is deprecated.  Use sena_common-msg:pos_known instead.")
  (pos_known m))

(cl:ensure-generic-function 'velocity_known-val :lambda-list '(m))
(cl:defmethod velocity_known-val ((m <BallInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader sena_common-msg:velocity_known-val is deprecated.  Use sena_common-msg:velocity_known instead.")
  (velocity_known m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<BallInfo>)))
  ...
  (cl:format cl:nil "Header header~%int32    ballinfostate~%PPoint   real_pos~%bool     pos_known~%bool     velocity_known~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: sena_common/PPoint~%float32 angle~%float32 radius~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'BallInfo)))
  "Returns full string definition for message of type 'BallInfo"
  (cl:format cl:nil "Header header~%int32    ballinfostate~%PPoint   real_pos~%bool     pos_known~%bool     velocity_known~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: sena_common/PPoint~%float32 angle~%float32 radius~%~%~%"))
