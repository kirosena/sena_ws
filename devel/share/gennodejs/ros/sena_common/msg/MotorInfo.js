...
class MotorInfo {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('motordata')) {
        ...
        this.motordata = new Array(3).fill(0);
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    if (obj.motordata.length !== 3) {
      throw new Error('Unable to serialize array field motordata - length must be 3')
    }
    // Serialize message field [motordata]
    bufferOffset = _arraySerializer.uint32(obj.motordata, buffer, bufferOffset, 3);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.motordata = _arrayDeserializer.uint32(buffer, bufferOffset, 3)
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.motordata !== undefined) {
      ...
      resolved.motordata = new Array(3).fill(0)
    }
